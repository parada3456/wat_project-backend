...
func (u *adminUseCase) ListPendingVerifications(ctx context.Context) ([]domain.UserMission, error) {
	log.Println("debugprint: entering (*adminUseCase).ListPendingVerifications")
	return u.adminRepo.ListPendingVerifications(ctx)
}

func (u *adminUseCase) ListUsers(ctx context.Context, search string) ([]domain.User, error) {
	log.Println("debugprint: entering (*adminUseCase).ListUsers")
	return u.adminRepo.SearchUsers(ctx, search)
}

func (u *adminUseCase) GetUserDetail(ctx context.Context, id string) (*domain.User, error) {
...
func (u *adminUseCase) VerifyMission(ctx context.Context, adminID, userMissionID string, approved bool, rejectionReason *string) (*domain.UserMission, error) {
