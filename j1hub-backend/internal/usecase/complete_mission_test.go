...
func TestCompleteMissionUseCase_SubmitProof_Success(t *testing.T) {
	...
	uc := usecase.NewCompleteMissionUseCase(
...
func TestCompleteMissionUseCase_VerifyMission_Approve(t *testing.T) {
	...
	umRepo.On("UpdateReward", ctx, userMissionID, mock.AnythingOfType("*domain.PointReward"), nowTime).Return(nil)
...
func TestCompleteMissionUseCase_SubmitProof_FindByID_Error(t *testing.T) {
	umRepo := new(MockUserMissionRepository)
	uc := usecase.NewCompleteMissionUseCase(umRepo, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil)
	ctx := context.Background()
	umRepo.On("FindByID", ctx, "ums_1").Return((*domain.UserMission)(nil), errors.New("db error"))
...
func TestCompleteMissionUseCase_SubmitProof_Forbidden(t *testing.T) {
	...
	uc := usecase.NewCompleteMissionUseCase(umRepo, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil)
	ctx := context.Background()
	mockUM := &domain.UserMission{UserID: "usr_456"}
...
func TestCompleteMissionUseCase_SubmitProof_AlreadyCompleted(t *testing.T) {
	...
	uc := usecase.NewCompleteMissionUseCase(umRepo, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil)
	ctx := context.Background()
	mockUM := &domain.UserMission{UserID: "usr_123", Status: domain.StatusCompleted}
	umRepo.On("FindByID", ctx, "ums_1").Return(mockUM, nil)
...
func TestCompleteMissionUseCase_SubmitProof_UploadError(t *testing.T) {
	umRepo := new(MockUserMissionRepository)
	storage := new(MockStoragePort)
	uc := usecase.NewCompleteMissionUseCase(umRepo, nil, nil, nil, nil, nil, nil, nil, storage, nil, nil, nil)
	ctx := context.Background()
	mockUM := &domain.UserMission{UserID: "usr_123", Status: domain.StatusInProgress}
	umRepo.On("FindByID", ctx, "ums_1").Return(mockUM, nil)
...
func TestCompleteMissionUseCase_SubmitProof_UpdateStatusError(t *testing.T) {
	...
	uc := usecase.NewCompleteMissionUseCase(umRepo, nil, nil, nil, nil, nil, nil, nil, storage, nil, nil, clock)
	ctx := context.Background()
	mockUM := &domain.UserMission{UserID: "usr_123", Status: domain.StatusInProgress}
	umRepo.On("FindByID", ctx, "ums_1").Return(mockUM, nil)
...
func TestCompleteMissionUseCase_VerifyMission_Reject_UpdateStatusError(t *testing.T) {
	...
	uc := usecase.NewCompleteMissionUseCase(umRepo, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil)
	ctx := context.Background()
	mockUM := &domain.UserMission{Status: domain.StatusPendingVerification}
	umRepo.On("FindByID", ctx, "ums_1").Return(mockUM, nil)
...
func TestCompleteMissionUseCase_VerifyMission_UpdateVerificationError(t *testing.T) {
	...
	uc := usecase.NewCompleteMissionUseCase(umRepo, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, clock)
	ctx := context.Background()
	mockUM := &domain.UserMission{Status: domain.StatusPendingVerification}
	umRepo.On("FindByID", ctx, "ums_1").Return(mockUM, nil)
...
func TestCompleteMissionUseCase_VerifyMission_UserFindByID_Error(t *testing.T) {
	...
	now := time.Now()
	clock := &MockClock{NowTime: now}
	uc := usecase.NewCompleteMissionUseCase(umRepo, nil, nil, nil, userRepo, nil, nil, nil, nil, nil, nil, clock)
	ctx := context.Background()
	mockUM := &domain.UserMission{Status: domain.StatusPendingVerification, UserID: "usr_1"}
	umRepo.On("FindByID", ctx, "ums_1").Return(mockUM, nil)
...
func TestCompleteMissionUseCase_VerifyMission_MissionFindByID_Error(t *testing.T) {
	...
	now := time.Now()
	clock := &MockClock{NowTime: now}
	uc := usecase.NewCompleteMissionUseCase(umRepo, missionRepo, nil, nil, userRepo, nil, nil, nil, nil, nil, nil, clock)
	ctx := context.Background()
	mockUM := &domain.UserMission{Status: domain.StatusPendingVerification, UserID: "usr_1", MissionID: "m_1"}
	umRepo.On("FindByID", ctx, "ums_1").Return(mockUM, nil)
	umRepo.On("UpdateVerification", ctx, "ums_1", now, "adm_1").Return(nil)
	userRepo.On("FindByID", ctx, "usr_1").Return(&domain.User{}, nil)
	missionRepo.On("FindByID", ctx, "m_1").Return((*domain.Mission)(nil), errors.New("db error"))
...
func TestCompleteMissionUseCase_VerifyMission_UpdateRewardError(t *testing.T) {
	...
	uc := usecase.NewCompleteMissionUseCase(umRepo, missionRepo, nil, nil, userRepo, nil, nil, nil, nil, nil, rewardEngine, clock)
	ctx := context.Background()
	mockUM := &domain.UserMission{Status: domain.StatusPendingVerification, UserID: "usr_1", MissionID: "m_1"}
	umRepo.On("FindByID", ctx, "ums_1").Return(mockUM, nil)
	umRepo.On("UpdateVerification", ctx, "ums_1", now, "adm_1").Return(nil)
	userRepo.On("FindByID", ctx, "usr_1").Return(&domain.User{}, nil)
	missionRepo.On("FindByID", ctx, "m_1").Return(&domain.Mission{}, nil)
...
func TestCompleteMissionUseCase_VerifyMission_IncrementPointsError(t *testing.T) {
	...
	umRepo.On("FindByID", ctx, "ums_1").Return(mockUM, nil)
	umRepo.On("UpdateVerification", ctx, "ums_1", now, "adm_1").Return(nil)
	userRepo.On("FindByID", ctx, "usr_1").Return(&domain.User{UserID: "usr_1"}, nil)
	missionRepo.On("FindByID", ctx, "m_1").Return(&domain.Mission{}, nil)
	umRepo.On("UpdateReward", ctx, "ums_1", mock.Anything, now).Return(nil)
