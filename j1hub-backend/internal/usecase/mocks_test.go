...
func (m *MockCreditScoreRepository) Create(ctx context.Context, c *userdomain.CreditScore) error {
	return m.Called(ctx, c).Error(0)
}
func (m *MockCreditScoreRepository) FindByUserID(ctx context.Context, userID string) (*userdomain.CreditScore, error) {
	args := m.Called(ctx, userID)
	if args.Get(0) == nil {
		return nil, args.Error(1)
	}
	return args.Get(0).(*userdomain.CreditScore), args.Error(1)
}
...
func (m *MockJourneyPhaseRepository) FindByNumber(ctx context.Context, number int) (*gamificationdomain.JourneyPhase, error) {
	args := m.Called(ctx, number)
	if args.Get(0) == nil {
		return nil, args.Error(1)
	}
	return args.Get(0).(*gamificationdomain.JourneyPhase), args.Error(1)
}
func (m *MockJourneyPhaseRepository) FindByID(ctx context.Context, id string) (*gamificationdomain.JourneyPhase, error) {
	args := m.Called(ctx, id)
	if args.Get(0) == nil {
		return nil, args.Error(1)
	}
...
func (m *MockUserPhaseHistoryRepository) Insert(ctx context.Context, h *gamificationdomain.UserPhaseHistory) error {
...
func (m *MockUserPhaseHistoryRepository) FindByUserAndPhase(ctx context.Context, userID, phaseID string) (*gamificationdomain.UserPhaseHistory, error) {
	args := m.Called(ctx, userID, phaseID)
	if args.Get(0) == nil {
		return nil, args.Error(1)
	}
	return args.Get(0).(*gamificationdomain.UserPhaseHistory), args.Error(1)
}
...
func (m *MockUserMissionRepository) UpdateReward(ctx context.Context, id string, reward *missiondomain.PointReward, rewardedAt time.Time) error {
