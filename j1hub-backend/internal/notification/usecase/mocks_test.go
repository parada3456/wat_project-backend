...
func (m *MockNotificationRepository) FindByUser(ctx context.Context, userID string, isRead *bool, limit, offset int) ([]notificationdomain.Notification, int, error) {
	args := m.Called(ctx, userID, isRead, limit, offset)
	if args.Get(0) == nil {
		return nil, args.Int(1), args.Error(2)
	}
