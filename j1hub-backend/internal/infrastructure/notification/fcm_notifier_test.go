...
func (m *MockUserRepo) FindUserJob(ctx context.Context, userID string) (*userdomain.UserJob, error) {
...
func (m *MockUserRepo) FindUserJobs(ctx context.Context, userID string) ([]userdomain.UserJob, error) {
	args := m.Called(ctx, userID)
	if args.Get(0) == nil {
		return nil, args.Error(1)
	}
...
func (m *MockUserRepo) AssignJob(ctx context.Context, userID, jobID string, isMain bool, startDate, endDate *time.Time) error {
