...
func SeedMockData(pool *pgxpool.Pool) error {
	...
	queries := []string{
		...
		('usr_somchai', 'somchai.j1@student.chula.ac.th', '$argon2id$v=19$m=65536,t=1,p=4$9o8p3gSSPWq2GK6884/oXQ$Y6y1Bry9hDlzuaZ9S/StpX4ddQqDwSyvQ/iATKuin1o', 'Somchai', 'Deejai', 'phs_002', 270, 270, 3, NOW() - INTERVAL '30 days', NOW() - INTERVAL '25 days'),
		...
		('prf_somchai', 'usr_somchai', '+66898765432', 'J1 student from Chulalongkorn University, Thailand.', 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d', 'Show_Friends', ST_SetSRID(ST_MakePoint(100.5118, 13.7663), 4326), NOW()),
