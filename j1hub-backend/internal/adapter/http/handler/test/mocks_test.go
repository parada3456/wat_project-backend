...
func (m *MockJourneyUC) ListPhases(ctx context.Context) ([]gamificationdomain.JourneyPhase, error) {
	args := m.Called(ctx)
	if args.Get(0) == nil {
...
func (m *MockJourneyUC) GetHistory(ctx context.Context, userID string) ([]gamificationdomain.UserPhaseHistory, error) {
