...
INSERT INTO users (user_id, email, password_hash, first_name, last_name, current_phase_id, total_lifetime_points, current_phase_points, mission_streak, arrival_date, job_start_date) VALUES
('usr_admin', 'admin@j1hub.com', '$argon2id$v=19$m=65536,t=1,p=4$9o8p3gSSPWq2GK6884/oXQ$Y6y1Bry9hDlzuaZ9S/StpX4ddQqDwSyvQ/iATKuin1o', 'Admin', 'User', 'phs_001', 0, 0, 0, NOW(), NOW()),
('usr_somchai', 'somchai.j1@kmitl.ac.th', '$argon2id$v=19$m=65536,t=1,p=4$9o8p3gSSPWq2GK6884/oXQ$Y6y1Bry9hDlzuaZ9S/StpX4ddQqDwSyvQ/iATKuin1o', 'Somchai', 'Deejai', 'phs_002', 270, 270, 3, NOW() - INTERVAL '30 days', NOW() - INTERVAL '25 days'),
('usr_alice', 'alice@example.com', '$argon2id$v=19$m=65536,t=1,p=4$9o8p3gSSPWq2GK6884/oXQ$Y6y1Bry9hDlzuaZ9S/StpX4ddQqDwSyvQ/iATKuin1o', 'Alice', 'Smith', 'phs_003', 460, 150, 4, NOW() - INTERVAL '60 days', NOW() - INTERVAL '55 days');

-- 3. Seed Profiles (using PostGIS points)
INSERT INTO profiles (profile_id, user_id, phone_number, bio, avatar_url, radar_visibility, current_coordinates, location_updated_at) VALUES
('prf_admin', 'usr_admin', '+66812345678', 'I am the admin of J1 Hub.', 'https://images.unsplash.com/photo-1535713875002-d1d0cf377fde', 'Hidden', ST_SetSRID(ST_MakePoint(100.5018, 13.7563), 4326), NOW()),
('prf_somchai', 'usr_somchai', '+66898765432', 'J1 student from kmitl University, Thailand.', 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d', 'Show_Friends', ST_SetSRID(ST_MakePoint(100.5118, 13.7663), 4326), NOW()),
('prf_alice', 'usr_alice', '+15551234567', 'J1 student from London, UK. Excited to work in the US!', 'https://images.unsplash.com/photo-1494790108377-be9c29b29330', 'Show_Anonymous', ST_SetSRID(ST_MakePoint(100.5218, 13.7763), 4326), NOW());

-- 4. Seed Friendships
INSERT INTO friendships (friendship_id, user_id_1, user_id_2, status) VALUES
('frn_somchai_alice', 'usr_somchai', 'usr_alice', 'Accepted');

-- 5. Seed User Phase History
