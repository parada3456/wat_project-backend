...
INSERT INTO profiles (profile_id, user_id, first_name, last_name, phone_number, bio, avatar_url, radar_visibility, current_coordinates, location_updated_at) VALUES
('prf_admin', 'usr_admin', 'admin', 'User', '+66812345678', 'I am the admin of J1 Hub.', 'https://images.unsplash.com/photo-1535713875002-d1d0cf377fde', 'hidden', ST_SetSRID(ST_MakePoint(100.5018, 13.7563), 4326), NOW()),
('prf_somchai', 'usr_somchai', 'Somchai', 'Deejai', '+66898765432', 'J1 student from kmitl University, Thailand.', 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d', 'show_friends', ST_SetSRID(ST_MakePoint(100.5118, 13.7663), 4326), NOW()),
('prf_alice', 'usr_alice', 'Alice', 'Smith', '+15551234567', 'J1 student from London, UK. Excited to work in the US!', 'https://images.unsplash.com/photo-1494790108377-be9c29b29330', 'show_anonymous', ST_SetSRID(ST_MakePoint(100.5218, 13.7763), 4326), NOW());
